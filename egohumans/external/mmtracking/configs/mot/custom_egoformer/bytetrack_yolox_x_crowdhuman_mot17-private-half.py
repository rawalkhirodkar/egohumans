_base_ = [
    ...
    '../../_base_/datasets/mot_challenge_custom.py', '../../_base_/default_runtime.py'
]
...
model = dict(
    ...
    motion=dict(type='KalmanFilter3D', weight_2d=1.0, weight_3d=1.0, fps=20),
    tracker=dict(
        type='ByteTrackerCustom',
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='VideoCollect', keys=['img', 'egoformer_yolox_detections', 'egoformer_yolox_roots_3d'], meta_keys=('extrinsics', 'depth_path'))
        ])
]
data = dict(
