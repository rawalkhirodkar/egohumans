...
data_image_resolution = (672, 504) ## height, width. 4:3 
model_image_resolution = (672, 504) ## model architecture 

heatmap_resolution = (192, 144) ## ratio of 3.5 compared to image_resolution
...
custom_hooks = [
    dict(type='VisualizeHook', vis_every_iters=500, max_samples=16, scale=3.5),
]
