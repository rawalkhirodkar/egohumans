...
# ###-----------------------------w32 256 x 192---------------------------
CONFIG_FILE='configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/seg_ViTPose_small_coco_256x192.py'
PRETRAINED='/media/rawalk/disk1/rawalk/vitpose/checkpoints/vitpose_small.pth'

###--------------------------------------------------------------
## add timestamp to output dir
OUTPUT_DIR="$(echo "Outputs/train/gtbbox_segvitpose_small_coco_256x192/$(date +"%m-%d-%Y_%H:%M:%S")")"
