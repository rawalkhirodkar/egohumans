...
OUTPUT_DIR="$(echo "Outputs/train/gtbbox_segvitpose_large_coco_256x192/$(date +"%m-%d-%Y_%H:%M:%S")")"

TRAIN_BATCH_SIZE_PER_GPU=64 ### default, lower batch size decreases the learning rate which in turns out better
