...
from .vit_seg import ViTSeg
from .eva import Eva
from .eva_judge import EvaJudge
from .eva_general import EvaGeneral
...
__all__ = [
    ...
    'LiteHRNet', 'V2VNet', 'HRFormer', 'ViT', 'ViTMoE', 'ViTCenter', 'ViTSeg',
    'Eva', 'EvaJudge', 'EvaGeneral'
]
