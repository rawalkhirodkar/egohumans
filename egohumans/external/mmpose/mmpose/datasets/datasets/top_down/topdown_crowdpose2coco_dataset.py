...
class TopDownCrowdPose2CocoDataset(TopDownCocoDataset):
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            for crowd_joint_index in range(len(CROWDPOSE_KEYPOINT_ORDER)):
                coco_joint_index = CROWDPOSE_TO_COCO_INDICES[crowd_joint_index]
                
                if coco_joint_index is not None:
                    joints_3d[coco_joint_index, :2] = keypoints[crowd_joint_index, :2]
                    joints_3d_visible[coco_joint_index, :2] = np.minimum(1, keypoints[crowd_joint_index, 2:3])
