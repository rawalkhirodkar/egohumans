...
class Kpt2dSviewRgbImgTopDownDataset(Dataset, metaclass=ABCMeta):
    ...
    def _xywh2cs(self, x, y, w, h, padding=1.25): ## 81.92, best 
    # def _xywh2cs(self, x, y, w, h, padding=1.75): ## 80.9
    # def _xywh2cs(self, x, y, w, h, padding=1.2): ## 81.82
    # def _xywh2cs(self, x, y, w, h, padding=1.3): ## 81.81
