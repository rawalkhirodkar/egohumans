...
def custom_vis_pose_result(model,
                    img,
                    result,
                    gt_result,
                    radius=4,
    ...
    pred_color = (0, 164, 255) ## orange

    pose_kpt_color[:, 0] = gt_color[0]
    pose_kpt_color[:, 1] = gt_color[1]
    pose_kpt_color[:, 2] = gt_color[2]

    pose_link_color[:, 0] = gt_color[0]
    pose_link_color[:, 1] = gt_color[1]
    pose_link_color[:, 2] = gt_color[2]

    temp = []
    for idx, val in enumerate(result):
        temp.append({'bbox': val['bbox'].copy(), 'keypoints': gt_result[idx]})
    ...
    ###--------------------------------
    pose_kpt_color[:, 0] = pred_color[0]
    pose_kpt_color[:, 1] = pred_color[1]
    pose_kpt_color[:, 2] = pred_color[2]

    pose_link_color[:, 0] = pred_color[0]
    pose_link_color[:, 1] = pred_color[1]
    pose_link_color[:, 2] = pred_color[2]
