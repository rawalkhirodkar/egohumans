...
from .inference import (inference_bottom_up_pose_model,
                        ...
                        process_mmdet_results, vis_pose_result, custom_vis_pose_result)
...
from .inference_seg import inference_top_down_seg_pose_model
...
__all__ = [
    ...
    'init_random_seed', 'inference_top_down_center_pose_model', 'inference_top_down_seg_pose_model'
]
