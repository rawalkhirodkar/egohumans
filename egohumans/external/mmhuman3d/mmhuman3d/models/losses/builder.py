...
from .prior_loss import CrouchRegLoss
...
LOSSES.register_module(name='CrouchRegLoss', module=CrouchRegLoss)
LOSSES.register_module(name='CollisionLoss', module=CollisionLoss)
