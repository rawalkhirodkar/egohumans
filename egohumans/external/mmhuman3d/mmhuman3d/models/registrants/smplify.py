...
class SMPLify(object):
    ...
    def __call__(self,
        ...
        for i in range(self.num_epochs):
            ...
            for stage_idx, stage_config in enumerate(self.stage_config):
                if self.verbose:
                    self.msg_template = '{}, epoch {}, stage {}, iter dummy:'.format(human_name, i, stage_idx)
        ...
        print('last epoch loss--------------------------{}'.format(last_epoch_loss))
    ...
    def _optimize_stage(self,
        ...
        for iter_idx in range(num_iter):
            self.msg = self.msg_template.replace('dummy', '{}/{}'.format(iter_idx, num_iter))
            def closure():
                optimizer.zero_grad()
